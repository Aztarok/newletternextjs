...
const EmailTransfer = () => {
	...
	return (
		<div className="text-charcoalGray flex flex-col gap-5">
			...
			<button
				onClick={() => router.push("/")}
				className="mt-auto font-semibold p-3 sm:mt-3 rounded-lg text-whiteBetter bg-darkSlateGray relative overflow-hidden bg-gradient-to-r hover:from-pink-500 hover:to-orange-500 hover:text-whiteBetter transition duration-300"
			>
				Dismiss message
			</button>
			       {" "}
